...
La vista previa de la recuperación ante desastres de BlueXP te permite utilizar completamente varias tecnologías de NetApp para lograr los siguientes objetivos:
